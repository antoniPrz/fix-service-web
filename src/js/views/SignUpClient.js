      ...
      <div className='row'>
        <div className='col-sm-12 col-lg-8'>
          <ul className='nav nav-pills nav-fill mb-5'>
            ...
            <li className='nav-item'>
              <Link to='/registroEspecialista' className='nav-link text-dark '>
        ...
        <div className=' col-sm-12 col-lg-4 mt-3 sideBar-right rounded border border-secondary'>
          <div className=' modal-dialog text-center '>
            <div className=''>
              ...
              <p className='mt-5'>
                Registrándote en nuestra aplicación como CLIENTE te ayudaremos a
                encontrar a los mejores prestadores de servicio en las
