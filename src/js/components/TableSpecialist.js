...
const TableRequestsSpecialist = () => {
  ...
  const CancelRequest = () => {
    if (option == -1) {
      ...
      if (
        valueDefault[option].requests.request_status == 'cancelada' ||
        valueDefault[option].requests.request_status == 'resuelta'
      ) {
    ...
    <div class='table-responsive'>
          ...
          {state == true ? (
            valueDefault.map((list, index) => (
              <tr key={index}>
                ...
                <td>
                  {list.requests.hour
                    .replace('morning', '08:00 - 11:00')
                    .replace('afternoon', '11:00 - 14:00')
                    .replace('evening', '14:00 - 17:00')}
                </td>
                <td>
      ...
      <div className='row justify-content-between mt-5'>
        ...
        <div className='col-sm-12 col-lg-4'>
          <button
            type='button'
            className='btn btn-block btn-ta-danger text-white'
        ...
        <div className='col-sm-12 col-lg-4'>
          <button
            type='button'
            className='btn btn-block btn-ta-blue  text-white'
